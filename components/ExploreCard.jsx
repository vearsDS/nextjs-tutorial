        ...
        {active !== id ? (
            <h3 className='font-semibold sm:text-[26px] text-[18px] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg] lg:origin-[0,0]'>
               {title} 
                ...
                <div className='absolute bottom-0 p-5 justify-start w-full flex flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]'>
                    ...
                    <p className='font-normal text-[0.8rem] leading-[0.5rem] text-white uppercase'>
                        Enter Lecerveaue
                    </p>
